...
def controller(turtlebot_frame, goal_frame):
  ...
  while not rospy.is_shutdown():
    try:
      ...
      print(K1*trans.transform.translation.x)
      print(K2*trans.transform.translation.y)
      control_command = Twist()
      # A = np.dot(np.array([[K1,0],[0,K2]]),x)
      # control_command.linear.x = A[0][0]
      # control_command.angular.z = A[1][0]
      ...
      print(control_command.angular.z)
